...
public class TpHereCommand implements CommandExecutor {
    ...
    public TpHereCommand(CherryCore plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command,
        ...
        if (!p.hasPermission("cherrycore.tphere")) {
        ...
        MessageUtils.sendPrefixed(p, "&d" + target.getName() + " &fteleportato da te.");
        MessageUtils.sendPrefixed(target, "&fTeleportato da &d" + p.getName() + "&f.");
        return true;
    }
}